...
import Card from "../../components/card1.jsx";
 ...
 function Home() {
    return (
          ...
          <div className="w-2/5">
            ...
            <div>
              ...
              <div className='flex flex-col md:flex-row gap-8 mt-10 hover:scale-105 transition-transform duration-300'>
                ...
                <p className="w-4/5 font-secondary font-extralight text-sm mt-2">Our mission is to shape communities by delivering durable, efficient, and future-ready construction solutions.</p>
                </div>
              </div>
              ...
              <div className='flex flex-col md:flex-row gap-8 mt-10 hover:scale-105 transition-transform duration-300'>
                ...
                <p className="w-4/5 font-secondary font-extralight text-sm mt-2">Our vision is to be a trusted leader in civil engineering, shaping infrastructure that drives progress across regions.</p>
                </div>
              </div>
        ...
        <section className="w-4/5 mx-auto bg-[#fcfcfc] h-screen grid grid-cols-3 grid-rows-2 justify-center border justify-items-center border-gray-300 px-5 ">
          <div>
